{name}Scott Zhang{/name}{company}PostgreSQL{/company}{title}Установка и настройка PostgreSQL в Azure{/title}{cat}Облачные решения{/cat}{date}01.02.2016{/date}{desc}Сегодня рассказываем как настроить PostgreSQL в Azure{/desc}
