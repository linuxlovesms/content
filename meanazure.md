{name}Vladimir Yunev{/name}{company}Microsoft{/company}{title}Развертывание стека MEAN на Microsoft Azure{/title}{cat}1{/cat}{date}12.04.2016{/date}{desc}Развертывание стека MEAN на Microsoft Azure{/desc}

Разработчики, которые создают решения в стеке MEAN могут легко размещать
свои решения в облачной платформе Microsoft Azure. Проще всего это
сделать с помощью виртуальных машин.
...
Рассмотрим, как любой пользователь Azure может развернуть стек MEAN за
несколько минут.

Поиск MEAN в Azure Marketplace
==============================
...
машину со стеком MEAN. Введите в строку поиска MEAN. Вы получите полный
список доступных в Azure Marketplace конфигураций MEAN на выбор (рисунок
2).

![](media/image2.png)


*Рис.2. – Список MEAN в Azure Marketplace*

Выберите MEAN и в новом информационном окне нажмите кнопку «Создать».
Теперь вы перейдете к непосредственному созданию виртуальной машины,
выбранной из Azure Marketplace (рисунок 3).
...
Чтобы создать виртуальную машину, в нашем случае с MEAN на борту,
...
развертывания вашей виртуальной машины с MEAN на борту.
...
Поздравляю! Вы развернули свою машину с готовым стеком MEAN.
...
администрирования. В моем случае это <http://13.69.252.216/>. Перейдя по
этому адресу, мы увидим стандартное приветствие (рисунок 10).

![](media/image11.png)


*Рис.10 – Стандартное приветствие от запущенной в Azure машины с MEAN*
...
подробное описание установленной конфигурации и компонент MEAN (рисунок
11).

![](media/image12.png)


*Рис.11. – Описание MEAN-стека*
...
<http://vyumean.northeurope.cloudapp.azure.com/>.
...
*SSH vyunev@vyumean.northeurope.cloudapp.azure.com*
...
Теперь вы можете настроить вашу VM с MEAN так как душа пожелает!

Заключение
==========

Мы рассмотрели простой пример того, как с помощью Azure и площадки Azure
Marketplace за считанные минуты можно развернуть окружение MEAN и
...
Redmine, SEO Panel, Parse, Git, GitLab, MEAN, ModX, Memcached, LAMP
